...
public class ExpectedVersions {
    ...
    public ExpectedVersions() {
        ...
        expectedVersions.put("hibernate", "5.0.5");
        expectedVersions.put("javascript", "ECMAScript 6");
        expectedVersions.put("ubuntu", "15.10");
        expectedVersions.put("nginx", "1.9.7");
        expectedVersions.put("elasticsearch", "2.1.0");
        expectedVersions.put("logstash", "2.1.0");
        expectedVersions.put("kibana", "4.3.0");
        ...
        expectedVersions.put("gnomeshell", "3.19.2");
        ...
        expectedVersions.put("internetexplorer", "11.0.25");
        expectedVersions.put("nmap", "7.00");
        expectedVersions.put("edge", "25.10586");
        expectedVersions.put("opera", "33.0");
        expectedVersions.put("postgresql", "9.4.5");
        expectedVersions.put("lighttpd", "1.4.38");
        ...
        expectedVersions.put("react", "0.14.3");
